<template>
  <div>
    <div class="min-h-screen bg-[#f8f7f4] p-10 font-sans text-[#09101d]">
      ...
      <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          <div class="p-8">
            ...
            <div class="mb-10">
              ...
              <div class="space-y-6">
                ...
                <div class="flex items-start justify-between">
                  ...
                  <p class="font-mono text-sm font-bold text-slate-600">
                    $24.00
                  </p>
                </div>
                <!-- Item 2 -->
            ...
            <!-- Guest Notes -->
            <div
              class="bg-[#f8f7f4] rounded-xl p-5 border border-slate-100 mb-8"
            >
